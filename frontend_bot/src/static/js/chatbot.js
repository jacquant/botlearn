        ...
        Engines: {
            ...
            backendinfo: function (token) {
                ...
                var capabilities = [
                    ...
                    "J'aurai deux fonctions:",
                    "1° La première sera de répondre aux questions que tu poseras dans le chat.",
                    "Je suis capable de comprendre les questions liées à la programmation",
                    "2° La deuxième sera de te donner un feedback plus précis sur ton code.",
                    "Pour se faire, il te suffit d'exécuter ton code via la bouton juste au-dessus de moi.",
                ];
