            ...
            <v-card-actions class="d-flex align-center justify-center">
              <p class="ma-0">
                <v-btn
                  color="green"
                  class="white--text"
                  :href="'http://localhost:8080/admin/exercises/exercise/'+exercice.id+'/change/'"
                  target="_blank"
                >
                  Modifier
                </v-btn>
            ...
            <template v-slot:header>
              ...
              >
                ...
                <v-btn
                  ...
                  depressed
                  medium
                  @click="search='';sortBy='Le plus récent'; filtering()"
                >
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            const is_staff = await http.get("user/get/", {headers: {"Authorization": "Bearer " + store.state.accessToken}});
