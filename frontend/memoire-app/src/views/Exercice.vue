                ...
                <v-col class="ml-10 mr-10">
                    ...
                    >
                        ...
                        <v-card-text>
                            <v-list>
                                <v-list-item >
                                    <div style="font-weight:bold">Consigne</div>: {{exercice.instruction}}
                                </v-list-item>
                                <v-list-item >
                                    <div style="font-weight:bold">Difficulté (1 à 4)</div>: {{exercice.difficulty}}
                                </v-list-item>
                                <v-list-item
                                    v-for="tag in exercice.tags"
                                    :key=tag
                                >
                                    <div style="font-weight:bold">Tag: </div>  {{tag}}
                                </v-list-item>
                                <v-list-item >
                        ...
                        <v-card-actions class="d-flex align-center justify-center">
                            <p class="ma-0"> 
                                <v-btn color="green" class="white--text" :href="'http://localhost:8080/admin/exercises/exercise/'+exercice.id+'/change/'" target="_blank">Modifier</v-btn>
                            </p>
                        </v-card-actions>
                    </v-card>
                </v-col>
                        ...
                        >
                            ...
                            <v-list dense>
                                <v-list-item>
                                    ...
                                    <v-list-item-content>{{printDate(item.date)}}</v-list-item-content>
                                </v-list-item>
                                <v-list-item>
                                    <v-list-item-content>Nombre d'erreurs:</v-list-item-content>
                                    <v-list-item-content>{{item.erreurs}}</v-list-item-content>
                                </v-list-item>
                            </v-list>
                            <v-divider></v-divider>
                            <v-card-actions class="d-flex align-center justify-center">
