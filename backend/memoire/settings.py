...
debug_in_environ = os.environ.get("DEBUG", True)
DEBUG = debug_in_environ in {"True", True, "true", "y", "yes"}
...
DB_IP = os.environ.get("DB_IP", "192.168.1.6")
...
base_auth = "django.contrib.auth.password_validation."
AUTH_PASSWORD_VALIDATORS = (
    {"NAME": "{0}UserAttributeSimilarityValidator".format(base_auth)},
    {"NAME": "{0}MinimumLengthValidator".format(base_auth)},
    {"NAME": "{0}CommonPasswordValidator".format(base_auth)},
    {"NAME": "{0}NumericPasswordValidator".format(base_auth)},
)
