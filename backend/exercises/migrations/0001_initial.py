...
# Generated by Django 3.0.3 on 2020-02-24 15:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name="Auteur de l'exercice")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_output', django.contrib.postgres.fields.jsonb.JSONField(default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_charge_persons', models.ManyToManyField(to=settings.AUTH_USER_MODEL, verbose_name='Les personnes responsables')),
                ('target', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='exercises.TargetStudents', verbose_name="Séance à destination de ce type d'étudiants")),
            ],
        ),
        migrations.CreateModel(
            name='Section',
        ...
        migrations.AddField(
            model_name='exercise',
            name='tags',
            field=models.ManyToManyField(to='exercises.Tag', verbose_name='Tags associés'),
        ),
    ]
