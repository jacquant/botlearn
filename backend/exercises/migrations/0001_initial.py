    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    constrainedfilefield.fields.file.ConstrainedFileField(
                        ...
                        validators=[exercises.models.utils.validate_file_extensions],
                    ),
                ),
                (
                    "author",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "submission_date",
                    models.DateTimeField(default=django.utils.timezone.now, verbose_name="Moment de la soumission"),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to=settings.AUTH_USER_MODEL, verbose_name="Les personnes responsables"
                    ),
                ),
                (
                    "target",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parent",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="exercises.Section"
                    ),
                ),
            ],
            options={"verbose_name": "section", "unique_together": {("parent", "number")},},
        ),
        migrations.AddField(
            model_name="exercise",
            name="requirements",
        ...
        migrations.AddField(
            ...
            name="tags",
            field=models.ManyToManyField(
                blank=True, related_name="exercises_tags", to="exercises.Tag", verbose_name="Tags associés"
            ),
        ),
    ]
